...
const ForgotPassword = () => {
    ...
    return (
        <Layout title={'Forgot Password - Eco-Nursery'}>
            <div className="form-container">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputEmail" placeholder='Enter your Favorite Sports' required />
                    </div>
                    <div className="mb-3">
